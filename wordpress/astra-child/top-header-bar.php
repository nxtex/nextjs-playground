...
/* =====================================================
   MODAL — fond #EBEBEB, hauteur naturelle, droite
===================================================== */
.mb-menu-modal {
	position: absolute;
	top: 64px;
	...
	/* Hauteur auto : grandit avec le contenu (ex. LIENS UTILES ouvert) */
	height: auto;
	max-height: none;
	overflow: visible;

	/* ⭐ Seul changement visuel : fond #EBEBEB */
	background: #EBEBEB;
	border: none;
	border-radius: 18px;
...
/* Bouton X — sombre (lisible sur #EBEBEB) */
.mb-modal-close {
	position: absolute;
	top: 12px;
	right: 12px;
...
.mb-modal-close:hover { background: rgba(0,0,0,.15); color: #000; }
...
@media (max-width: 768px) {
	.mb-menu-modal {
		...
		scrollbar-color: rgba(249,144,0,.3) transparent;
	}
	.mb-menu-modal:not([hidden]) { transform: translateY(0); opacity: 1; }
}

/* =====================================================
   CONTENU POPUP #4269 — styles originaux sombres
===================================================== */
.mb-menu-premium {
	--mb-orange: #f99000;
	--mb-orange-2: #ffb347;
...
/* Panels liens utiles — styles originaux sombres */
...
.mb-link-card:hover .mb-link-arrow { color: var(--mb-orange-2); }
</style>
