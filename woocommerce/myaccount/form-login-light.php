<?php
/**
 * Login Form — Tabs Design Light Mode (Monbedo)
...
<style>
  /* ── Page background ── */
  body.woocommerce-account { background-color: #f5f5f5 !important; }
  ...
  body.woocommerce-account #page { background-color: #f5f5f5 !important; }
  ...
  form.login, form.register { border: 0px !important; }
  ...
  .mb-points-banner span { color: #cc7a00; font-size: 0.78rem; font-weight: 600; line-height: 1.4; }
  ...
  .mb-box .lost_password a:hover, .mb-box a:hover { color: #374151 !important; }
  ...
  .mb-box p { color: #6b7280; font-size: 0.78rem; line-height: 1.5; margin-bottom: 1rem; }
...
<div class="mb-login-wrap">
  ...
  <div class="mb-title-wrap">
    <span class="mb-title" id="mb-title-text">De retour</span>
          ...
          <form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?>>
            ...
            <p class="woocommerce-form-row form-row-wide">
              <label for="reg_birthday">
                ...
                <span style="color:#9ca3af;font-size:0.65rem;text-transform:none;letter-spacing:0;margin-left:0.3rem;">(<?php esc_html_e( 'facultatif', 'woocommerce' ); ?>)</span>
              </label>
...
var MB_TITLES = { login: 'De retour', register: 'Bienvenue' };
...
function mbSwitchTab(tab, el) {
  ...
  mbMorphTitle(MB_TITLES[tab] || 'De retour');
}
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (url.get('action') === 'register') {
    ...
    if (bar) bar.style.width = Math.min('De retour'.length * 7.5, 90) + 'px';
  }
